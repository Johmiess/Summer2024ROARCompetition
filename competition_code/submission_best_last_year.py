...
class RoarCompetitionSolution:
    ...
    async def step(
        ...
        with open("sim_log_best_last_year.csv", "a") as f:
            f.write(f"{current_time}, {vehicle_location[0]}, {vehicle_location[1]}, {vehicle_rotation[2]}, {vehicle_velocity_norm}, {steer_control}, {throttle}, {brake}, {gear}\n")
